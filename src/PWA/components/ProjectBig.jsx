...
const ProjectBig = ({projectData}) => {
    ...
    return(<div className={"project-big"} onClick={handleProjectClick}>
        ...
        <div className="img-container"><img src={projectData.imageSrcMain}/>
            ...
            <div className="info">
                <div className="data">{projectData.selectedBedrooms} bdrm</div>
                <div className="data">{(projectData.priceFrom/projectData.sizeFrom).toFixed(0)} USD</div>
                <div className="data">{projectData.sizeFrom} sq.ft</div>
            </div>
        </div>
        <div className="information">
            <div className="general">
                <div className="name">{projectData.projectName}</div>
                <div className="location">{projectData.selectedLocation||projectData.ownLocation}</div>
            </div>
            <div className="price">
                From <span>${formatNumberWithCommas(projectData.priceFrom)}</span>
            </div>
        </div>
        </Link>
    </div>)
