...
const AboutUsPhone = ({handleMenuToggle}) => {
    ...
    return (<div className="about-us-phone">
        ...
        <div className="pdfs">
            <a className="pdf"  href='https://propart-pdfs.s3.me-south-1.amazonaws.com/Pro+Part+RERA+Certificate.pdf' download>
                <div className="title">
                ...
                <div>OWNER BROKER ID</div>
            </a>

            <a className="pdf" href='https://propart-pdfs.s3.me-south-1.amazonaws.com/BROKER+ID.pdf'
                 download>
                <div className="title">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28" fill="none">
                        <path
