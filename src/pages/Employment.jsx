...
import accountaingBaner from "../assets/empBG.png";
                    ...
                    <div className="card">
                        <div className="content">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 150 150"
                                ...
                                <g opacity="0.1">
                                    <path
                                        d="M12 118.75C12.2761 118.75 12.5 118.526 12.5 118.25V50.5C12.5 50.2239 12.2761 50 12 50H6.75C6.47386 50 6.25 49.7761 6.25 49.5V38C6.25 37.7239 6.47386 37.5 6.75 37.5H24.5C24.7761 37.5 25 37.2761 25 37V25C25 23.3424 25.6585 21.7527 26.8306 20.5806C28.0027 19.4085 29.5924 18.75 31.25 18.75H118.75C120.408 18.75 121.997 19.4085 123.169 20.5806C124.342 21.7527 125 23.3424 125 25V37C125 37.2761 125.224 37.5 125.5 37.5H143.25C143.526 37.5 143.75 37.7239 143.75 38V49.5C143.75 49.7761 143.526 50 143.25 50H138C137.724 50 137.5 50.2239 137.5 50.5V118.25C137.5 118.526 137.724 118.75 138 118.75H143.25C143.526 118.75 143.75 118.974 143.75 119.25V130.75C143.75 131.026 143.526 131.25 143.25 131.25H6.75C6.47386 131.25 6.25 131.026 6.25 130.75V119.25C6.25 118.974 6.47386 118.75 6.75 118.75H12ZM80.75 118.75C81.0261 118.75 81.25 118.526 81.25 118.25V75.5C81.25 75.2239 81.0261 75 80.75 75H69.25C68.9739 75 68.75 75.2239 68.75 75.5V118.25C68.75 118.526 68.9739 118.75 69.25 118.75H80.75ZM49.5 118.75C49.7761 118.75 50 118.526 50 118.25V75.5C50 75.2239 49.7761 75 49.5 75H38C37.7239 75 37.5 75.2239 37.5 75.5V118.25C37.5 118.526 37.7239 118.75 38 118.75H49.5ZM112 118.75C112.276 118.75 112.5 118.526 112.5 118.25V75.5C112.5 75.2239 112.276 75 112 75H100.5C100.224 75 100 75.2239 100 75.5V118.25C100 118.526 100.224 118.75 100.5 118.75H112ZM38 31.25C37.7239 31.25 37.5 31.4739 37.5 31.75V37C37.5 37.2761 37.7239 37.5 38 37.5H112C112.276 37.5 112.5 37.2761 112.5 37V31.75C112.5 31.4739 112.276 31.25 112 31.25H38Z"
                                        fill="#C29773"/>
                                </g>
                            </svg>
                        </div>
