...
const PhoneMap = ({handleMenuToggle}) => {
    ...
    return(<div className={"phone-map"}>
        <MenuProject handleMenuToggle={handleMenuToggle} setFilterOpen={setFilterOpen} handleItemChange={handleItemChange} />
        ...
        {filterOpen===true&&<div className="filter-prop">
            ...
            <div className="content">
                <div className="apply" onClick={()=>setFilterOpen(false)}>Apply filter</div>
